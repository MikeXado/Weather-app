  ...
  var api = `https://api.weatherapi.com/v1/forecast.json?key=13001c2bc9a841669a8154010220603&q=`
  var city = document.querySelector("#locationIn");
  var apiKey = `&days=1&aqi=no&alerts=no`;
...
function getApi () {
 ...
 .then((data) =>{
     const {temp_c, precip_mm , humidity , wind_kph} = data.current;
